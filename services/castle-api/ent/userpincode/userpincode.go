...
const (
	// Label holds the string label denoting the userpincode type in the database.
	Label = "user_pin_code"
	...
	EdgeRoom = "room"
	// Table holds the table name of the userpincode in the database.
	Table = "user_pin_codes"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "user_pin_codes"
...
// Columns holds all SQL columns for userpincode fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldContactID,
...
// OrderOption defines the ordering options for the UserPinCode queries.
