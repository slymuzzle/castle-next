...
func (dq *DeviceQuery) FirstID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (dq *DeviceQuery) FirstIDX(ctx context.Context) pulid.ID {
...
func (dq *DeviceQuery) OnlyID(ctx context.Context) (id pulid.ID, err error) {
	var ids []pulid.ID
...
func (dq *DeviceQuery) OnlyIDX(ctx context.Context) pulid.ID {
...
func (dq *DeviceQuery) IDs(ctx context.Context) (ids []pulid.ID, err error) {
...
func (dq *DeviceQuery) IDsX(ctx context.Context) []pulid.ID {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (dq *DeviceQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Device, init func(*Device), assign func(*Device, *User)) error {
	...
	nodeids := make(map[pulid.ID][]*Device)
	for i := range nodes {
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_device" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
