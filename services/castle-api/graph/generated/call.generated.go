...
type MutationResolver interface {
	StartCall(ctx context.Context, roomID pulid.ID) (bool, error)
	EndCall(ctx context.Context, roomID pulid.ID) (bool, error)
	DeclineCall(ctx context.Context, roomID pulid.ID) (bool, error)
...
func (ec *executionContext) _Mutation_startCall(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().StartCall(rctx, fc.Args["roomID"].(pulid.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_endCall(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().EndCall(rctx, fc.Args["roomID"].(pulid.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_declineCall(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeclineCall(rctx, fc.Args["roomID"].(pulid.ID))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
